	...
	set output fname . '_ilu0.tex'
 	
	set xrange [0:1000]
	set yrange [1e-15:1e-0]

	set style fill solid border -1
	set key at 980, 1e-01 opaque
	#set key top right 
	...
	set ytics ('\footnotesize -16' 1e-16, '\footnotesize -14' 1e-14, '\footnotesize -12' 1e-12, \
	  '\footnotesize -10' 1e-10, '\footnotesize -8' 1e-8, '\footnotesize -6' 1e-6, \
