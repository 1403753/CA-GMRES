	...
	set output 'residuals_dmat2_2.tex'
  ...
  cmax4 = system("head -1 " . '../gnuplot/gmres_newt_large_s.dat' . " | awk '{print $4}'")
	...
	set title '\shortstack{\footnotesize 1e+04 $\times$ 1e+04 diagonal, logspace eigs, cond 1e+10 \\ \footnotesize Residual 2-norm, log scale}'
	
	plot '../gnuplot/gmres_standard.dat' using 1:2 title '\scriptsize GMRES(75)' linecolor "black" with lines, \
		'../gnuplot/gmres_mono_small_s.dat' using 1:2 title '\begin{minipage}[l]{.95\textwidth} \scriptsize Monomial-GMRES(15,5) \newline \tiny min, max rcond \#: ' . cmin1 . ', ' . cmax1 . '\end{minipage}' linecolor "blue" pt 6 ps 1, \
		'../gnuplot/gmres_newt_small_s.dat' using 1:2 title '\begin{minipage}[l]{.95\textwidth} \scriptsize Newton-GMRES(15,5) \newline \tiny min, max rcond \#: ' . cmin2 . ', ' . cmax2 . '\end{minipage}' linecolor "green" pt 8 ps 1, \
		'../gnuplot/gmres_mono_large_s.dat' using 1:2 title '\begin{minipage}[l]{.95\textwidth} \scriptsize Monomial-GMRES(25,3) \newline \tiny min, max rcond \#: ' . cmin3 . ', ' . cmax3 . '\end{minipage}' linecolor "magenta" pt 6 ps 1, \
		'../gnuplot/gmres_newt_large_s.dat' using 1:2 title '\begin{minipage}[l]{.95\textwidth} \scriptsize Newton-GMRES(25,3) \newline \tiny min, max rcond \#: ' . cmin4 . ', ' . cmax4 . '\end{minipage}' linecolor "cyan" pt 8 ps 1
