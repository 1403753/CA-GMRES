	...
	#set key at 400, 5e-04
	set key top right opaque
	set key box vertical width -84 height 0.1
	...
	#set ytics 1e-10,1e-1,1e+10
	
	set ytics ('\footnotesize -16' 1e-16, '\footnotesize -15' 1e-15, '\footnotesize -14' 1e-14, '\footnotesize -13' 1e-13, '\footnotesize -12' 1e-12, \
		'\footnotesize -11' 1e-11, '\footnotesize -10' 1e-10, '\footnotesize -9' 1e-9, '\footnotesize -8' 1e-8, '\footnotesize -7' 1e-7, '\footnotesize -6' 1e-6, \
  ...
  cmax4 = system("head -1 " . '../gnuplot/gmres_newt_large_s.dat' . " | awk '{print $5}'")
	...
	plot '../gnuplot/gmres_standard.dat' using 1:2 title '\scriptsize GMRES('. m .') + ilu(0)' linecolor "black" with lines, \
		'../gnuplot/gmres_mono_small_s.dat' using 1:2 title '\begin{minipage}[l]{.95\textwidth} \scriptsize Monomial-GMRES(' . s1 . ',' . t1 . ')  + ilu(0) \newline \tiny min, max basis rcond \#: ' . cmin1 . ', ' . cmax1 . '\end{minipage}' linecolor "blue" pt 6 ps 1 , \
		'../gnuplot/gmres_newt_small_s.dat' using 1:2 title '\begin{minipage}[l]{.95\textwidth} \scriptsize Newton-GMRES(' . s1 . ',' . t1 . ')  + ilu(0) \newline \tiny min, max basis rcond \#: ' . cmin2 . ', ' . cmax2 . '\end{minipage}' linecolor "green" pt 8 ps 1, \
