...
\begin{center}
	\resizebox{1.0\textwidth}{!}{\input{residuals_dmat1.tex}}
	\resizebox{1.0\textwidth}{!}{\input{residuals_dmat2.tex}}
	\resizebox{1.0\textwidth}{!}{\input{residuals_dmat3.tex}}
	\resizebox{1.0\textwidth}{!}{\input{residuals_dmat1_2.tex}}
	\resizebox{1.0\textwidth}{!}{\input{residuals_dmat2_2.tex}}
	\resizebox{1.0\textwidth}{!}{\input{residuals_dmat3_2.tex}}		
\end{center}
