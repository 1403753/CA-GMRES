...
public:
	...
	static sparse_status_t update_H(ScalarType *H, ScalarType *R, ScalarType *B, std::vector<ic_pair_t, mkl_allocator<ic_pair_t>>  theta_vals, size_t s, size_t m, size_t k);
