...
\begin{picture}(7200.00,5040.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \csname LTb\endcsname%
      \put(876,2349){\makebox(0,0)[l]{\strut{}\scriptsize GMRES(20)}}%
      \csname LTb\endcsname%
      \put(876,2030){\makebox(0,0)[l]{\strut{}\begin{minipage}[l]{.95\textwidth} \scriptsize Monomial-GMRES(5,4) \newline \tiny min, max basis rcond \#: 1.51e-12, 8.52e-06\end{minipage}}}%
      \csname LTb\endcsname%
      \put(876,1711){\makebox(0,0)[l]{\strut{}\begin{minipage}[l]{.95\textwidth} \scriptsize Newton-GMRES(5,4) \newline \tiny min, max basis rcond \#: 1.11e-12, 8.18e-04\end{minipage}}}%
      \csname LTb\endcsname%
      \put(876,1392){\makebox(0,0)[l]{\strut{}\begin{minipage}[l]{.95\textwidth} \scriptsize Monomial-GMRES(5,6) \newline \tiny min, max basis rcond \#: 2.02e-18, 4.03e-15\end{minipage}}}%
      \csname LTb\endcsname%
      \put(876,1073){\makebox(0,0)[l]{\strut{}\begin{minipage}[l]{.95\textwidth} \scriptsize Newton-GMRES(5,6) \newline \tiny min, max basis rcond \#: 1.05e-16, 6.36e-02\end{minipage}}}%
    }%
    \gplbacktext
