...
%             bool = 1;
            ...
            if (nargin < 8)
               ...
               %fprintf('Theta_val at L: %e\n', y);
                ...
                if (num_points > 1)
                    ...
                    %fprintf('Theta_val at L (scaled): %e\n', y);
                    %fprintf('New capacity estimate: %e\n', capacity);
                end
            end
            zprod = zeros(n,1);
            count = 0;
    ...
    %fprintf('Shifts before Leja ordering:\n');
    %x
    ...
    %fprintf('Shifts after Leja ordering:\n');
    %y
end